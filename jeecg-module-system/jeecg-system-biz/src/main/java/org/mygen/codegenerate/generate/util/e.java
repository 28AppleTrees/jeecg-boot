...
public class e {
    ...
    private static String d() {
        ...
        try {
            ...
            try {
                String var3 = System.getProperty("user.dir") + File.separator + "config" + File.separator + org.mygen.codegenerate.generate.util.d.e();
            ...
            if (var1 == null) {
                var1 = ResourceBundle.getBundle(org.mygen.codegenerate.generate.util.d.d());
            }

            var0 = ((ResourceBundle)var1).getString(org.mygen.codegenerate.generate.util.d.g());
            byte[] var6 = org.mygen.codegenerate.generate.util.d.a(org.mygen.codegenerate.generate.util.d.i(), var0);
            var0 = new String(var6, "UTF-8");
            String[] var7 = var0.split("\\|");
            if (!var7[1].equals(b())) {
                System.out.println(org.mygen.codegenerate.generate.util.d.h() + b());
